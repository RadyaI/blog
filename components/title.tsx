    ...
    return (
        <>
            <div className="py-2 mx-auto sm:mt-2 flex sm:h-[40dvh]">
                {!isFilter && (<div className={`animate__animated ${isAnimate ? "animate__fadeOutLeft" : "animate__fadeInLeft"} -ml-10 hidden mt-5 sm:flex gap-4 sm:flex-col border-[red] w-1/3`}>
                ...
                {!isFilter && (<div className={`animate__animated ${isAnimate ? "animate__fadeOutRight" : "animate__fadeInRight"} -mr-10 hidden mt-5 sm:flex gap-4 sm:flex-col border-[red] w-1/3`}>
                    <div className="w-full h-1/2 flex items-end justify-around">
